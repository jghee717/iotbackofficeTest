...
$(document).ready(function(){
  if(weekNumberByMonth(today).weekNo - 2 <= 1){
    $("#nextWrapper").hide();
    $("#prevWrapper").hide();
    $(".week_wrapper").css({"padding-left":"1rem","padding-right":"1rem","padding-bottom":"0.6rem","padding-top":"0.3rem"});
  }else{
    $("#nextWrapper").hide();
  }
  ...
  // 배틀그룹 확인
  var nowWeek = weekNumberByMonth(today).weekNo - 2 == 0 ? 1 : weekNumberByMonth(today).weekNo - 2;
  getBattleGroup(nowWeek);
});
    ...
    , success : function(d){
            ...
            d.forEach(function(item, idx){
              ...
              if(idx % 2 == 0){
                str += "<tr class=\"r"+item.chan_group+"\" style=\"text-align:center;\">"
                        ...
                        +"<td class=\"numeric result-data\" style=\"display:none;\" data-title=\"총합\">"+item.result+"</td>"
        ...
        $(".r1").each(function(a){
            if(r1 == null || r1 == undefined)
              ...
              if(Number(r1) > Number($(this).find('.result-data').html())){
        ...
        // 귀찮...
        $(".r2").each(function(a){
            if(r1 == null || r2 == undefined)
              r2 = $(this).find('.result-data').html();
            else{
              if(Number(r2) > Number($(this).find('.result-data').html())){
        ...
        $(".r3").each(function(a){
            if(r3 == null || r3 == undefined)
              ...
              if(Number(r3) > Number($(this).find('.result-data').html())){
...
/**
  ...
  @brief 6월 만 이벤트라 6월만 계산 일단.
*/
function getWeekDays(a){
  var currentDay = new Date('2019-06-03');
