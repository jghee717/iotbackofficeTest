...
<div class="form-group row" >
  ...
  <div class="col-12 col-sm-8 col-lg-6">
    ...
    <div class="" style="border:1px solid black; margin-top: 10px">
      ...
      <select class="send_image" name="send_image[]" multiple style="display:none"><!-- 선택된이미지 저장 --></select>
      <div id="choice_image" style="overflow-y:scroll;height:300px; text-align:center"><!-- 선택된 이미지 목록 --></div>
